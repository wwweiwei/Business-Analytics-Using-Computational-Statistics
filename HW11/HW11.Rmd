...
# plot the points
with(cars_light, plot(log.acceleration., log.mpg., pch=1, col ="blue", lwd=1, main = "Effect of acceleration on mpg depends on weight of car"))
...
abline(regr_light, col = "blue", lwd=2, lty=1) 
...
- Answer: I think is **weight**, because weight is more significant than acceleration in Question 1 <br>
...
summary(lm(log.mpg. ~ cars_log$log.weight. + cars_log$log.acceleration. + interaction_ortho, data = cars_log))
```
